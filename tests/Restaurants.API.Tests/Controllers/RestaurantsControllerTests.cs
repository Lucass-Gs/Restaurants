...
public class RestaurantsControllerTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    private readonly Mock<IRestaurantsRepository> _restaurantsReposiatorsMock = new();
        ...
        _factory = factory.WithWebHostBuilder(builder =>
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Replace(ServiceDescriptor.Scoped(typeof(IRestaurantsRepository),
                    _ => _restaurantsReposiatorsMock.Object));
    ...
    public async Task GetById_ForNonExistingId_ShouldReturn404NotFound()
    {
        ...
        _restaurantsReposiatorsMock.Setup(m => m.GetByIdAsync(id)).ReturnsAsync((Restaurant?)null);
    ...
    public async Task GetById_ForExistingId_ShouldReturn200Ok()
    {
        ...
        _restaurantsReposiatorsMock.Setup(m => m.GetByIdAsync(id)).ReturnsAsync(restaurant);
